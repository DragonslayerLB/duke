...
public class Constants {
    ...
    public static String GOOD_BYE_LINE = "Bye. Hope to see you again soon!";
    public static String LIST_OF_TASKS_LINE = "Here are the tasks in your list";
    ...
    public static String TASK_FOUND_LINE = "Here are the matching tasks in your list";
